            ...
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-border">
                <tr>
                  ...
                  <td className="px-5 py-3 text-foreground/50">Safety car incidents (6 pts each, cap 12) — deployments within 10 minutes count as one incident, and interruptions deliberately weigh less than on-track action. Virtual safety cars (4 pts each, cap 8), red flags (12 pts each, cap 12). Combined cap 25.</td>
                ...
                <tr>
                  ...
                  <td className="px-5 py-3 text-foreground/50">8 pts per sustained leader — a driver who held P1 for at least 5 cumulative minutes of race time, so lap-1 scrambles and pit-cycle blips don't count. 2 pts per driver who gains 5+ places net, or triggers the recovery drive signal. Cap 40.</td>
        ...
        <section className="flex flex-col gap-4">
          ...
          <div className="rounded-xl border border-border bg-card p-5 flex flex-col gap-3">
            ...
            <p className="text-sm text-foreground/60 leading-relaxed">
              ...
              " "}<span className="text-foreground/80">5.0 or above</span>. Below that threshold the verdict
